...
public class UpdatesSettings extends PreferenceFragmentCompat implements
    ...
    public void onStartDownload(UpdatePreference pref) {
        ...
        if (!isOnWifiOrEthernet() && !isMobileDataWarningIgnored()) {
            ...
            View checkBoxView = inflater.inflate(R.layout.ignore_mobile_data_warning_checkbox, null);
            CheckBox checkbox = (CheckBox) checkBoxView.findViewById(R.id.ignore_mobile_data_warning_checkbox);
            checkbox.setText(R.string.ignore_mobile_data_warning);
                ...
                .setPositiveButton(R.string.dialog_download, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (checkbox.isChecked()) {
                            mPrefs.edit().putBoolean(Constants.IGNORE_MOBILE_DATA_WARNING_PREF, true).apply();
                        }

...
public class UpdatesSettings extends PreferenceFragment implements
    ...
    private boolean mABUpdateRunning = false;
    ...
    void checkForUpdates() {
        if (mProgressDialog != null || mABUpdateRunning) {
            return;
        }
    ...
    public void onStartUpdate(UpdatePreference pref) {
        ...
        if (mStartUpdateVisible || mABUpdateRunning) {
            return;
        }

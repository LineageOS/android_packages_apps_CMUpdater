...
public class UpdatePreference extends Preference implements OnClickListener, OnLongClickListener {
    ...
    protected void onBindView(View view) {
        ...
        String mApi;
        switch (mUpdateInfo.getApiLevel()) {
            case 23:
                mApi = "6.0.1";
                break;
            case 25:
                ...
                break;
            default:
                mApi = String.format("API %1$d", mUpdateInfo.getApiLevel());
                break;
        }
        ...
        switch (mStyle) {
            case STYLE_DOWNLOADED:
                ...
                mTitleText.setText(String.format("%1$s %2$s",
                        mBuildName[4], mContext.getString(R.string.type_downloaded)));
            ...
            case STYLE_DOWNLOADING:
                ...
                mTitleText.setText(String.format("%1$s %2$s",
                        mBuildName[4], mContext.getString(R.string.type_downloading)));
                break;
            ...
            case STYLE_INSTALLED:
                ...
                mButton.setVisibility(View.GONE);
                mTitleText.setText(String.format("%1$s %2$s",
                        mBuildName[4], mContext.getString(R.string.type_installed)));
                break;
            ...
            default:
                ...
                mProgressBar.setVisibility(View.GONE);
                mButton.setVisibility(View.VISIBLE);
                mTitleText.setText(mBuildName[4]);
